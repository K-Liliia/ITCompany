...
public class Others extends Employee {
	...
	private static final Logger logger = Logger.getLogger(Others.class);
	private String additionalInfo;

	public Others(String lastName, String firstName, int age, String sex, int workExperience, int salary) {
